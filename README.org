...
Until a Firefox Add-ons release is available, install the Firefox build manually from [[https://github.com/artawower/avy-tab-switcher/releases][GitHub Releases]].

1. Download and extract the Firefox package from the latest release.
